...
const TYPOGRAPHY_THEME:
  ...
  h2: { fontSize: DEFAULT_SIZE * 2, fontWeight: 500 },
  h3: { fontSize: DEFAULT_SIZE * 1.5, fontWeight: 500 },
  h4: { fontSize: DEFAULT_SIZE * 1.25, fontWeight: 400 },
  h5: { fontSize: DEFAULT_SIZE, fontWeight: 400 },
  h6: { fontSize: DEFAULT_SIZE * 0.75, fontWeight: 400 },
