        ...
        <Content>
          <FlexboxGrid justify="center" align="middle"  >
            <FlexboxGrid.Item colspan={12}>
              <Panel
              header={<div>
                        <img src={logo} alt="animated photo of Nitin" style={{width:"30%",minWidth:"65px",maxWidth:"150px", height:"auto", borderRadius:"100%"}}/>
                        <br/><br/>
                        <h1 style={{color:"#EEEEEE", fontSize:"30px"}}>Hey there! I'm Nitin Ramesh <span class="wave">👋</span></h1>
                        </div>}
              bordered
