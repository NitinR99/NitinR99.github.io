        ...
        <Content>
          <FlexboxGrid justify="center" align="middle"  >
            <FlexboxGrid.Item colspan={12}>
              <Panel header={<div><img src={logo} alt="animated photo of Nitin" style={{width:"150px", borderRadius:"100%"}}/><br/><br/><h1 style={{color:"#EEEEEE", fontSize:"30px"}}>Hey there! I'm Nitin Ramesh 👋</h1></div>} bordered style={{ position: "fixed", top: "50%",  left: "50%",   transform: "translate(-50%, -50%)", textAlign:"center"}} >
